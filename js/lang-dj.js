...
window.EP_I18N = {
  ...
  ca: {
    ...
    'dj.n.eyebrow': 'Els noms',
    'dj.n.title': 'Quatre projectes, un criteri',
    'dj.n.lead': 'Cada estil té el seu nom, perquè cada públic espera una cosa diferent. Per a un esdeveniment es tria el que encaixa, i això es decideix al briefing.',
    'dj.n1.tag': 'Nom general',
    'dj.n1.text': 'Esdeveniments d’empresa, celebracions i casaments. Repertori obert i sessió construïda a partir del briefing: és el nom amb què treballo en producció d’esdeveniments.',
    'dj.n2.tag': 'Trance',
    'dj.n2.text': 'El projecte de psytrance, en festivals i clubs. Aura Open Air Festival, Misa Psicodèlika i l’escena de Barcelona.',
    'dj.n3.tag': 'House · duo',
    'dj.n3.text': 'Duo de house. Dues cabines treballant alhora, per quan l’esdeveniment demana una pista sostinguda i amb cos.',
    'dj.n4.tag': 'Funky · world music',
    'dj.n4.text': 'Funky i world music. El registre més càlid i ballable, el que millor funciona en un sopar, un vermut o una festa amb públic barrejat.',
  ...
  en: {
    ...
    'dj.n.eyebrow': 'The names',
    'dj.n.title': 'Four projects, one judgement',
    'dj.n.lead': 'Each style has its own name, because each crowd expects something different. For an event we pick the one that fits, and that is decided at the briefing.',
    'dj.n1.tag': 'General name',
    'dj.n1.text': 'Company events, celebrations and weddings. Open repertoire and a set built from the brief: this is the name I work under in event production.',
    'dj.n2.tag': 'Trance',
    'dj.n2.text': 'The psytrance project, at festivals and clubs. Aura Open Air Festival, Misa Psicodélika and the Barcelona scene.',
    'dj.n3.tag': 'House · duo',
    'dj.n3.text': 'A house duo. Two booths working at once, for when the event calls for a sustained floor with some body to it.',
    'dj.n4.tag': 'Funky · world music',
    'dj.n4.text': 'Funky and world music. The warmest, most danceable register, the one that works best at a dinner, a vermouth or a party with a mixed crowd.',
    'dj.f.eyebrow': 'Formats',
