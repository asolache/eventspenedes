...
(function () {
  ...
  var I18N = {
    ...
    ca: {
      ...
      'ven.v1.s3': 'Torrelles de Foix',
      'ven.v1.s4': 'Aforament a consultar',
      'ven.v2.tag': 'Espai propi · TeamTowers',
      'ven.v2.title': 'El Taller de Castells',
      'ven.v2.text': 'Espai cobert d’entrenament casteller, adaptat a grups d’empresa. És la seu natural del taller «Fent Pinya»: es fa plogui o no, amb monitors castellers i tot el material de seguretat. El taller és de TeamTowers — fitxa completa a <a href="https://www.teamtowers.eu" target="_blank" rel="noopener">teamtowers.eu</a>.',
      'ven.v2.s1': 'Cobert',
    ...
    en: {
      ...
      'ven.v2.text': 'A covered human-tower training hall adapted for corporate groups. It is the natural home of the «Fent Pinya» workshop: it runs rain or shine, with experienced casteller instructors and all safety equipment. The workshop is run by TeamTowers — full details at <a href="https://www.teamtowers.eu" target="_blank" rel="noopener">teamtowers.eu</a>.',
      'ven.v2.s1': 'Indoor',
