...
window.EP_I18N = {
    ...
    ca: {
      ...
      'par.p1': 'Taller de castells \u00abFent Pinya\u00bb, Cal Segue i el Taller de Castells.',
      'par.note': 'Tens un espai, un celler o un servei al Pened\u00e8s i vols entrar a la xarxa? Escriu-nos.',
      ...
      'act.g1': 'Grup d\u2019empresa aixecant un castell al taller \u00abFent Pinya\u00bb, amb monitors castellers de camisa vermella',
      'act.g2': 'Castell constru\u00eft dins d\u2019una sala durant un taller d\u2019empresa',
      'act.g3': 'Participants amb mocador vermell celebrant el castell completat',
      'act.g4': 'Una participant a dalt de tot, amb el grup aplaudint des de baix',
      'act.note': 'Imatges de tallers \u00abFent Pinya\u00bb de TeamTowers, en espais diferents i amb grups d\u2019empresa.',
    ...
    en: {
      ...
      'ven.v1.title': 'Cal Segue',
      'ven.v1.text': 'At Cal Segue we rent the outdoor space: the tiled terrace, the covered porch with its barbecue and the garden, surrounded by vineyards with the hills behind. It is the place for a tasting, a human-tower workshop or a meal in the open air. The inside of the house is not for rent.',
      'ven.v1.s1': 'Barri Cusconar, Torrelles de Foix',
      ...
      'par.p1': 'The \u00abFent Pinya\u00bb human-tower workshop, Cal Segue and the Castells Workshop.',
      'par.note': 'Do you run a venue, a winery or a service in the Penedès and want to join the network? Get in touch.',
      ...
      'act.g1': 'A company group raising a human tower at the \u00abFent Pinya\u00bb workshop, with casteller instructors in red shirts',
      'act.g2': 'A human tower built indoors during a company workshop',
      'act.g3': 'Participants in red headscarves celebrating the completed tower',
      'act.g4': 'A participant at the very top, with the group applauding from below',
      'act.note': 'Images from TeamTowers \u00abFent Pinya\u00bb workshops, in different spaces and with company groups.',
